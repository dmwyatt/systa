...
def method_decorator(
    decorator: Callable[..., AnyCallable], predicates: Sequence[PredicateCallable]
...
def has_parameter(
    parameter_name: str, annotation: Optional[type] = dontcheck
) -> PredicateCallable:
...
def get_value_by_arg_name(
    func: AnyCallable, arg_name: str, args: Sequence[Any], kwargs: Mapping[str, Any]
) -> Any:
...
def raise_on_return_value(
    exc: ExcCallable, return_value: T
