...
class IdleCheck:
    ...
    Model
    -----
    (See :download:`Excel file <idle_time_model.xlsx>`)
    ...
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
    | 9                      | 0.12           | 8.88                  | TRUE            | FALSE                 | 1            | TRUE          |
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
    | 10                     | 0.12           | 9.88                  | TRUE            | FALSE                 | 2            | TRUE          |
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
    ...
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
    | 19                     | 10.32          | 8.68                  | TRUE            | FALSE                 | 1            | TRUE          |
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
    | 20                     | 10.32          | 9.68                  | TRUE            | FALSE                 | 2            | TRUE          |
    +------------------------+----------------+-----------------------+-----------------+-----------------------+--------------+---------------+
